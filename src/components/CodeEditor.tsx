...
function CodeEditor() {
  ...
  const [code, setCode] = useState(
    selectedQuestion.starterCode[
      language as keyof typeof selectedQuestion.starterCode
    ]
  );
  ...
  const handleQuestionChange = (questionId: string) => {
    ...
    setCode(
      question.starterCode[
        language as keyof typeof question.starterCode
      ]
    );
  };
  ...
  const handleLanguageChange = (newLanguage: string) => {
    ...
    setCode(
      selectedQuestion.starterCode[
        newLanguage as keyof typeof selectedQuestion.starterCode
      ]
    );
  };
